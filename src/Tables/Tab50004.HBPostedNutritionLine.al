table 50004 "HB Posted Nutrition Line"
{
    Caption = 'HB Könyvelt Táplálkozás Sor';
    DataClassification = CustomerContent;
    LookupPageId = "HB Posted Nutrition Order Subp";
    DrillDownPageId = "HB Posted Nutrition Order Subp";
    ...
    fields
    {
        field(1; "Nutrition No."; Code[20])
        {
            ...
            DataClassification = CustomerContent;
            TableRelation = "HB Posted Nutrition Header"."Nutrition No.";
        }
        field(2; "No."; Integer)
        {
            Caption = 'Sorszám';
